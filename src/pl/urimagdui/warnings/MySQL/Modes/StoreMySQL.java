...
import pl.urimagdui.warnings.Utils.TimeUtil;
...
public class StoreMySQL implements Store
{
    ...
    public StoreMySQL(final String host, final int port, final String user, final String pass, final String name, final String prefix) {
        ...
        }.runTaskTimer((Plugin) Main.getPlugin(), 600L, 600L);
    }
    ...
    public boolean connect() {
        ...
        try {
            ...
            Logger.info("Polaczono z baza danych MySQL!", "Ping do bazy: " + t.stop().getExecutingTime() + "ms!");
            return true;
        }
